...
class _HomePageWidgetState extends State<HomePageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResultfqn = await ServiciosWalletGroup.menuCall.call();
      if ((_model.apiResultfqn?.succeeded ?? true)) {
        setState(() {
          FFAppState().itemsMenu = (ServiciosWalletGroup.menuCall.listaMenu(
            (_model.apiResultfqn?.jsonBody ?? ''),
          ) as List)
    ...
    _model.textController ??= TextEditingController(text: 'Buscar Usuario');
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 4.0, 44.0, 0.0),
                                child: Text(
                                  'Bienvenido aca  esta el resumen de sus actividades',
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 4.0, 0.0, 0.0),
                                          child: Text(
                                            'Esta es la actividad de los ultimos 30 dias',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyText2,
                                          ),
                                        ),
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        'Personas suscritas al servicio',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyText2,
